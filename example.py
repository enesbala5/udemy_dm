...
bot = InstaBot(
    ...
    tag_list=["blockchain", "AI", "tutorial", "tech", "programming", "design", "course","learn","technology",
            "education", "udemy","solution", "development","business","webdevelopment", "datascience", "python", "javascript", "courses", "coding"],
